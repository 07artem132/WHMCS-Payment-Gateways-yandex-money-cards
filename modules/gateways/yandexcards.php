 ...
 */
yandexcards_loadLang();

function yandexcards_config() {
    global $_LANG;
    ...
    $configarray = array(
        ...
        'receiver' => array(
            'FriendlyName' => $_LANG['yandexcards_number_yandex_purse'],
            'Type' => 'text',
            'Size' => '25',
            'Default' => '',
            'Description' => $_LANG['yandexcards_wallet_for_transfer_of_money'],
        ),
        'Secret' => array(
            'FriendlyName' => $_LANG['yandexcards_Secret'],
            'Type' => 'text',
            'Size' => '25',
            'Default' => '',
            'Description' => $_LANG['yandexcards_Secret_des'],
        ),
        'URLscript' => array(
            'FriendlyName' => $_LANG['yandexcards_URL_script'],
            'Description' => $_SERVER['REQUEST_SCHEME'] . '://' . $_SERVER['HTTP_HOST'] . '/modules/gateways/callback/yandex.php',
        ),
        'author' => array(
            'FriendlyName' => $_LANG['yandexcards_Author'],
            'Description' => 'Artem Ivanko <a href="mailto:a_ivanko@service-voice.com">a_ivanko@service-voice.com</a>',
        ),
        'Poweredby' => array(
            'FriendlyName' => $_LANG['yandexcards_Powered_by'],
...
function yandexcards_link($params) {
    global $_LANG;
    ...
    logModuleCall($module = 'yandexcards', __FUNCTION__, $requeststring = [ 'params' => $params], $responsedata = null, $processeddata = ['code' => $code, 'fields' => $fields], $replacevars = null);

    return $code;
}

function yandexcards_loadLang($lang = null, $default = 'russian') {
    global $_LANG, $CONFIG;
    $Langpath = (dirname(__FILE__) . '/lang/yandexcards');
